...
public class TestParallelSolver extends Thread {
...
static byte[][] grid = {
    ...
    public static void main(String[] args) {
        Date start = new Date();
        LinkedList<SequentialSolver.Sudoku> allSolutions = solveBoard(2);
        Date end = new Date();
    ...
    public TestParallelSolver(SudokuStack stack){
        this.stack = stack;
    }
    ...
    public static LinkedList<SequentialSolver.Sudoku> solveBoard(int threadNumber) {
        ...
        Sudoku sudoku = new Sudoku(grid,0,0);
        stack.push(sudoku);
